...
void requiredFieldGroup() {
  group('AppValidators.requiredField', () {
    test('rejects empty values', () {
      expect(
        AppValidators.requiredField(null, field: 'Name'),
        AppString.fieldIsRequired('Name'),
      );
      expect(
        AppValidators.requiredField('', field: 'Name'),
        AppString.fieldIsRequired('Name'),
      );
    });
...
void usernameGroup() {
  group('AppValidators.usernameValidator', () {
    test('rejects invalid usernames', () {
      expect(
        AppValidators.usernameValidator('ab'),
        AppString.fieldMinLength('Name', 4),
      );
      expect(
        AppValidators.usernameValidator('user name'),
        AppString.fieldNoSpaces('Name'),
      );
    });
...
void emailGroup() {
  group('AppValidators.emailValidator', () {
    test('rejects invalid emails', () {
      ...
      expect(
        AppValidators.emailValidator('bad'),
...
void legacyPasswordGroup() {
  group('AppValidators.passwordValidator', () {
    test('rejects invalid legacy passwords', () {
      expect(
        AppValidators.passwordValidator('pass1'),
...
void resetPasswordGroup() {
  group('AppValidators.resetPasswordValidator', () {
    test('rejects invalid reset passwords', () {
      expect(
        AppValidators.resetPasswordValidator('pass12'),
        AppString.resetPasswordRequirement,
      );
    });
...
void confirmPasswordGroup() {
  group('AppValidators.confirmPasswordValidator', () {
    test('rejects mismatched passwords', () {
      expect(
        AppValidators.confirmPasswordValidator('Pass1234', 'Pass9999'),
...
void phoneGroup() {
  group('AppValidators.phoneValidator', () {
    test('rejects invalid phone numbers', () {
      ...
      expect(
        AppValidators.phoneValidator('0123456789'),
