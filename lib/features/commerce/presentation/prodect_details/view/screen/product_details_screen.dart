...
import 'package:flower_app/features/commerce/presentation/prodect_details/view/widgets/product_details_empty_state.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
            ...
            Expanded(
              child: BlocBuilder<ProductDetailsViewModel, ProductDetailsState>(
                builder: (context, state) {
                  ...
                  if (product == null) {
                      return const ProductDetailsEmptyState();
          ...
          AppButton(text: AppString.addToCart, onPressed: (){})
          ],
        ),
      ),
    );
